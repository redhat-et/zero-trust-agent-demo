...
echo ""
echo "# List documents"
echo "curl http://localhost:8080/documents"
echo ""
echo "# Access document (as Alice - engineering user)"
echo "curl -X POST http://localhost:8080/access \\"
...
echo "curl -X POST http://localhost:8080/documents \\"
echo "  -H 'Content-Type: application/json' \\"
...
echo "curl -X DELETE http://localhost:8080/documents/DOC-TEST \\"
echo "  -H 'X-SPIFFE-ID: spiffe://demo.example.com/user/bob'"
echo ""
